...
export type $OpenApiTs = {
  ...
  '/video/:/transcode/universal/start.mpd': {
    get: {
      req: StartUniversalTranscodeData;
      res: {
        /**
  ...
  '/activities/{activityUUID}': {
    delete: {
      req: CancelServerActivitiesData;
      res: {
        /**
  ...
  '/security/resources': {
    get: {
      req: GetSourceConnectionInformationData;
      res: {
        /**
