...
export function isDirectInstanceOf<T>(
  instance: unknown,
  class_: Class<T>,
): instance is T {
...
export function isEnumCase<T = unknown>(
  value: unknown,
  targetEnum: T,
): boolean {
  // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
...
export function isNodeStream(value: unknown): value is NodeStream {
  return (
    isObject(value) &&
    isFunction((value as NodeStream).pipe) &&
    !isObservable(value)
  );
}
...
// TODO: Use `not ''` when the `not` operator is available.
export function isNonEmptyStringAndNotWhitespace(
  value: unknown,
...
function typeErrorMessage(
  ...
  return `Expected value which is \`${description}\`, received value of type \`${is(
    value,
  )}\`.`;
}
...
function typeErrorMessageMultipleValues(
  expectedType: AssertionTypeDescription | AssertionTypeDescription[],
  values: unknown[],
): string {
  ...
  return `Expected values which are ${orFormatter.format(
    uniqueExpectedTypes,
  )}. Received values of type${
    uniqueValueTypes.length > 1 ? 's' : ''
  } ${andFormatter.format(uniqueValueTypes)}.`;
}
...
function keysOf<T extends Record<PropertyKey, unknown>>(
  value: T,
): Array<keyof T> {
...
export function assertAny(
  ...
  if (!isAny(predicate, ...values)) {
    const predicates = isArray(predicate) ? predicate : [predicate];
    const expectedTypes = predicates.map((predicateFn) =>
      isIsMethodName(predicateFn.name)
        ? methodTypeMap[predicateFn.name]
        : 'predicate returns truthy for any value',
    );
...
export function assertArrayLike<T = unknown>(
  value: unknown,
  message?: string,
): asserts value is ArrayLike<T> {
...
export function assertBigInt64Array(
  value: unknown,
  message?: string,
): asserts value is BigInt64Array {
...
export function assertBigUint64Array(
  value: unknown,
  message?: string,
): asserts value is BigUint64Array {
...
// eslint-disable-next-line @typescript-eslint/ban-types
export function assertBoundFunction(
  value: unknown,
  message?: string,
): asserts value is Function {
...
export function assertEmptyObject<Key extends keyof any = string>(
  value: unknown,
  message?: string,
): asserts value is Record<Key, never> {
...
export function assertEmptyString(
  value: unknown,
  message?: string,
): asserts value is '' {
...
export function assertEmptyStringOrWhitespace(
  value: unknown,
  message?: string,
): asserts value is string {
...
export function assertEvenInteger(
  value: number,
  message?: string,
): asserts value is number {
...
export function assertFloat64Array(
  value: unknown,
  message?: string,
): asserts value is Float64Array {
...
export function assertInfinite(
  value: unknown,
  message?: string,
): asserts value is number {
  if (!isInfinite(value)) {
...
export function assertInt8Array(
  value: unknown,
  message?: string,
...
export function assertMap<Key = unknown, Value = unknown>(
  value: unknown,
  message?: string,
): asserts value is Map<Key, Value> {
  if (!isMap(value)) {
...
export function assertNativePromise<T = unknown>(
  value: unknown,
  message?: string,
): asserts value is Promise<T> {
...
export function assertNodeStream(
  value: unknown,
  message?: string,
...
export function assertNonEmptyArray<T = unknown, Item = unknown>(
  value: T | Item[],
  message?: string,
): asserts value is [Item, ...Item[]] {
...
export function assertNonEmptyMap<Key = unknown, Value = unknown>(
  value: unknown,
  message?: string,
): asserts value is Map<Key, Value> {
...
export function assertNonEmptySet<T = unknown>(
  value: unknown,
  message?: string,
): asserts value is Set<T> {
...
export function assertNonEmptyStringAndNotWhitespace(
  value: unknown,
  message?: string,
): asserts value is string {
...
// eslint-disable-next-line @typescript-eslint/ban-types
export function assertNullOrUndefined(
  value: unknown,
  message?: string,
): asserts value is null | undefined {
...
export function assertOddInteger(
  value: number,
  message?: string,
): asserts value is number {
...
export function assertPlainObject<Value = unknown>(
  value: unknown,
  message?: string,
): asserts value is Record<PropertyKey, Value> {
...
export function assertTupleLike<T extends Array<TypeGuard<unknown>>>(
  value: unknown,
  guards: [...T],
  message?: string,
): asserts value is ResolveTypesOfTypeGuardsTuple<T> {
...
export function assertUrlInstance(
  value: unknown,
  message?: string,
...
export function assertValidLength(
  value: unknown,
  message?: string,
): asserts value is number {
...
// eslint-disable-next-line @typescript-eslint/ban-types
export function assertWeakMap<Key extends object = object, Value = unknown>(
  value: unknown,
  message?: string,
): asserts value is WeakMap<Key, Value> {
  if (!isWeakMap(value)) {
...
// eslint-disable-next-line @typescript-eslint/ban-types
export function assertWeakRef<T extends object = object>(
  value: unknown,
  message?: string,
): asserts value is WeakRef<T> {
  if (!isWeakRef(value)) {
...
// eslint-disable-next-line @typescript-eslint/ban-types
export function assertWeakSet<T extends object = object>(
  value: unknown,
  message?: string,
): asserts value is WeakSet<T> {
  if (!isWeakSet(value)) {
...
export function assertWhitespaceString(
  value: unknown,
  message?: string,
): asserts value is string {
