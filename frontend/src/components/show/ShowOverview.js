...
class ShowOverview extends React.Component {
  ...
  render() {
    let criticRating = this.props.seriesData.vote_average;

    let director = this.findNested(this.props.seriesData.credits.crew, "job", "Director");

    let screenplay = this.findNested(this.props.seriesData.credits.crew, "job", "Screenplay");
          ...
          <div className="detail--wrap">
            <div className="detail--content">
              <div className="detail--bar">
                <p>{new Date(this.props.seriesData.first_air_date).getFullYear()}</p>
                <div className="detail--bar--sep">·</div>
                <p className="runtime">
                  {this.timeConvert(
                    Array.isArray(this.props.seriesData.episode_run_time)
                      ? this.props.seriesData.episode_run_time[0]
                      : this.props.seriesData.episode_run_time
                  )}
                </p>
                <div className="detail--bar--sep">·</div>
                <p>
              ...
              <div className="genre--wrap">
                {this.props.seriesData.genres.map((genre, i) => {
                  // if (i === this.props.seriesData.genres.length - 1) return genre.name;
                  return (
              ...
              <p className="overview">{this.props.seriesData.overview}</p>
            </div>
          </div>
        </div>
      </section>
