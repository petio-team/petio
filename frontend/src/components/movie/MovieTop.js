...
class MovieTop extends React.Component {
  render() {
    ...
    return (
      <div className={`movie-top ${this.props.trailer ? "show-trailer" : ""}`}>
        <div className="movie-backdrop" key={`${this.props.movieData.title}__backdrop`}>
          ...
          {this.props.movieData.backdrop_path ? (
            <LazyLoadImage
              src={"https://image.tmdb.org/t/p/w1280/" + this.props.movieData.backdrop_path}
        ...
        <div className="movie-details">
          ...
          <div className="movie-details--top">
            {this.props.movieData.logo ? (
              <LazyLoadImage className="movie-logo" src={this.props.movieData.logo} />
            ) : (
              <h1 className="single-title">{this.props.movieData.title}</h1>
            )}
          </div>
