  ...
  render() {
    ...
    return (
      <div className="sr--wizard">
        <div className="sr--wizard--top">
          <p>{this.props.title}</p>
          <div className="close" onClick={this.props.closeWizard}>
            <Close />
          </div>
        </div>
        <div className="sr--wizard--content">
          <label>Title</label>
          ...
          <button className="btn" onClick={this.props.saveServer}>
            Save
          </button>
