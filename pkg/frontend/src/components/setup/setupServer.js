	...
	function saveServer() {
		if (!picked)
			props.newNotification({
				type: 'error',
				message:
					'No server selected please pick a server from the list',
			});
	...
	return (
		<div className="step-3">
			...
			<p className={`${typo.body} mb-2`}>
				Note: Plex Direct urls sometimes change or break so we
				don&apos;t advise using them.
			</p>
						...
						return (
							<div
								...
								className={`${styles.server_option} ${
									picked === key
										? styles.server_option__selected
										: ''
								} ${
							...
							>
								...
								<div className={styles.server_option__status}>
									<div
										className={`${
											styles.server_option__status__item
										} ${
