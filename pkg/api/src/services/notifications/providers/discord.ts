import { Embeds } from '@/infrastructure/discord/requests/request';
import Embed, { EmbedField } from '@/infrastructure/discord/structure/embed';
import DiscordWebhook from '@/infrastructure/discord/webhook';
