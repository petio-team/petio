...
export default (app: Router) => {
  ...
  route.get("/thumb/:id", async (req, res) => {
  ...
  route.get("/quota", async (req: any, res) => {
    if (!req.jwtUser) {
      res.sendStatus(404);
      return;
    }
  ...
  route.post("/create_custom", async (req, res) => {
  ...
  route.post("/bulk_edit", async (req, res) => {
  ...
  route.post("/thumb/:id", async (req: any, res) => {
    if (!req.params.id) {
